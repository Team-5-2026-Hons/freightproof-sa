...
Remove the temporary instrumentation. Keep the reproduction as a test if the project has tests. And write one line — in the commit message or the project's AGENTS.md gotchas — saying what the cause was, so this hunt never has to happen twice.
