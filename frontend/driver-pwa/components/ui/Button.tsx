...
const sizeClass = {
  ...
  // Driver PWA default — large touch targets for field use
  lg: 'px-6 py-3.5 text-[14px] gap-2 min-h-[52px]',
}

export function Button({
  variant = 'primary',
  size = 'lg',          // driver default is lg (full-width touch target)
  loading = false,
  disabled,
  iconLeft: IconLeft,
  iconRight: IconRight,
  fullWidth = true,     // driver default is full-width
  className,
  children,
  ...rest
}: ButtonProps) {
