...
// H1/H4 dropped their photo-only step (gate photos removed at these points); H3
// keeps 3 steps — its step 2 still does seal confirmation, just without a photo.
...
export const STEP_NAMES: Record<1 | 2 | 3 | 4 | 5, string[]> = {
  1: ['Gate Arrival', 'Verification'],
  2: ['Arrive at Bay', 'Confirm Linehaul', 'Photograph Waybill', 'Capture Seal', 'Review & Submit'],
  3: ['Approach Exit Gate', 'Confirm Seal', 'Confirm Departure'],
  4: ['Destination Gate Arrival', 'Seal Verification'],
